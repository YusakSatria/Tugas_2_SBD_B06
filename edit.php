...
// query data pasien berdasarkan NIK
        ...
        <form action="" method="post">
            ...
            <ul>
                ...
                <div class="form_select mb-3" name="pendidikan" id="pendidikan" required="">
                    ...
                    <input type="text" name="pendidikan" value="<?=$pasien["pendidikan"];?>"> 
                </div>
